			...
			<SupportSectionContainer>
				...
				<SupportSection sectionTitle="Provide an accessible world-class robotics education">
					<div className="flex flex-col">
						<div>
							...
							Our free, interactive learning platform makes learning feel like play, and that's by design: Learning is easier when you're having fun.
						</div>
					</div>
				</SupportSection>
				<SupportBorder />
				<SupportSection sectionTitle="How we got here" extraClasses="mt-10">
					<div className="flex flex-col space-y-4">
						<div>
							We're a small team of Mechanical Engineers from leading U.S. engineering schools, with experience at SpaceX and in fast-paced trading firms.
						</div>
						<div>
				...
				<SupportSection sectionTitle="The Lever Labs Difference" extraClasses="mt-10">
					<div className="flex flex-col space-y-4">
						...
						<div>
							Pip and the Lever Labs Platform work together seamlessly to turn abstract concepts into hands-on experiences.
