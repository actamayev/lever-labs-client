	...
	return (
		<div className="min-h-screen pb-20 px-4 sm:px-8 md:px-16 lg:px-60">
			<div className="relative pt-16">
				<ComplianceMainHeader>Terms and Conditions of Service</ComplianceMainHeader>
				<ComplianceParagraph>
			...
			<div>
				...
				<ComplianceParagraph>
					Blue Dot Robots websites ("Websites"), educational robots ("Pip Robots"), and related services (together with the Websites, the "Service") are operated by Blue Dot Robots, Inc. ("Blue Dot Robots," "us," or "we"). Access and use of the Service is subject to the following Terms and Conditions including any future modifications. By accessing or using any part of the Service, purchasing Pip Robots, or creating an account, you represent that you have read, understood, and agree to be bound by these Terms and Conditions.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					Blue Dot Robots is committed to providing safe, age-appropriate educational content suitable for learners of all backgrounds. Our platform is designed to promote STEM learning, critical thinking, and problem-solving skills through engaging robotics activities.
				</ComplianceParagraph>
				...
				<ComplianceParagraph>
					As a condition of using the Service and creating coding projects, robotics programs, or other educational content through the platform ("Student Content"), you retain full ownership of your Student Content. However, to enable Blue Dot Robots to provide educational services and operate the platform, you hereby grant to Blue Dot Robots a perpetual, irrevocable, worldwide, royalty-free, non-exclusive, transferable, and sublicensable license to use, reproduce, modify, adapt, distribute, publicly display, create derivative works from, and otherwise utilize Student Content. This license includes the right to use Student Content for educational purposes, platform improvement, machine learning model training, research and development, marketing and promotional materials, and any other purposes related to Blue Dot Robots' educational mission.
				</ComplianceParagraph>
				<ComplianceParagraph>
					You acknowledge that this license allows Blue Dot Robots to showcase exemplary student work, analyze coding patterns to improve our educational algorithms, and use anonymized or aggregated project data for research purposes. However, you retain ownership of your original Student Content and may continue to use, modify, and share your projects as you wish. Blue Dot Robots will not sell your individual projects to third parties or use your personal information in connection with showcased work without appropriate permissions.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					All content available through the Service, including but not limited to lesson materials, robot designs, software interfaces, educational curricula, graphics, images, text, audio files, video content, Blue Dot Robots branding, and the Pip robot hardware and software designs ("Service Content"), are the proprietary property of Blue Dot Robots or its licensors. No Service Content may be modified, copied, distributed, reproduced, republished, downloaded, displayed, posted, transmitted, reverse engineered, or sold in any form or by any means, in whole or in part, other than as expressly permitted in these Terms and Conditions.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Business Names and Proprietary Rights:</strong> "Blue Dot Robots," "Pip," and all other business names, logos, designs, graphics, and proprietary marks used in connection with the Service are the property of Blue Dot Robots or their respective owners and are protected by applicable intellectual property laws. Access and use of the Service does not grant or provide you with the right or license to reproduce or otherwise use the Blue Dot Robots name, logos, designs, or any Blue Dot Robots or third-party proprietary marks without our prior written consent.
				</ComplianceParagraph>

				<ComplianceSectionHeader>9. Hardware Purchase Terms</ComplianceSectionHeader>
				<ComplianceParagraph>
					<strong>Robot Sales and Delivery:</strong> Blue Dot Robots offers Pip educational robots for purchase by schools, educational institutions, and individual consumers. All robot purchases are subject to these Terms and Conditions and any additional purchase agreements executed between Blue Dot Robots and the purchaser. Pricing, availability, and specifications are subject to change without notice. All orders are subject to acceptance by Blue Dot Robots, and we reserve the right to refuse or cancel any order for any reason.
				</ComplianceParagraph>
				<ComplianceParagraph>
					<strong>Title and Risk of Loss:</strong> Physical ownership of individual Pip robot units transfers to the purchaser upon delivery and full payment. Risk of loss or damage to the physical robot transfers to the purchaser upon delivery to the shipping address provided. Purchasers are responsible for inspecting robots upon delivery and reporting any damage or defects within 48 hours of receipt. Blue Dot Robots will arrange for shipping through reputable carriers, but is not responsible for shipping delays, damage during transit, or delivery issues beyond our reasonable control. Blue Dot Robots retains all intellectual property rights in the Pip robot design, software, and technology.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Intended Use and Safety:</strong> Pip robots are designed for educational use. Users must follow all safety guidelines provided with the robots. Blue Dot Robots is not liable for injuries or damages resulting from misuse, modification, or use outside of normal educational activities.
				</ComplianceParagraph>

				<ComplianceSectionHeader>10. Subscription Services</ComplianceSectionHeader>
				<ComplianceParagraph>
					<strong>Teacher Portal and Dashboard Services:</strong> Blue Dot Robots offers optional subscription services, including teacher portals and administrative dashboards that provide enhanced classroom management features, progress tracking, assignment distribution, and educational analytics. These subscription services are offered primarily to schools and educational institutions, though individual educators may also subscribe subject to availability and our discretion.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Parental Consent Agent:</strong> When schools create accounts for students under the age of thirteen (13), the school represents and warrants that it has obtained all necessary parental consents and agrees to act as Blue Dot Robots' agent for compliance with the Children's Online Privacy Protection Act (COPPA) and other applicable privacy laws. Schools must maintain appropriate documentation of parental consent and provide such documentation to Blue Dot Robots upon request. Schools represent that they have the authority to provide such consent on behalf of parents/guardians as part of their educational mission and enrollment agreements with families.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Limited Hardware Warranty:</strong> Blue Dot Robots provides a one (1) year limited warranty from the date of delivery for Pip robots against defects in materials and workmanship under normal use conditions. During this warranty period, Blue Dot Robots will repair or replace defective robots at no cost to the purchaser. This warranty does not cover damage caused by accidents, misuse, unauthorized modifications, normal wear and tear, or failure to follow provided care instructions.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Entire Agreement:</strong> These Terms and Conditions, together with our Privacy Policy and any applicable Additional Terms, constitute the entire agreement between Blue Dot Robots and you concerning the subject matter hereof and supersede all prior agreements, understandings, negotiations, and discussions, whether oral or written, between the parties. Any additional or different terms proposed by you are expressly rejected unless explicitly agreed to in writing by Blue Dot Robots.
				</ComplianceParagraph>
				<ComplianceParagraph>
					<strong>Order of Precedence:</strong> In the event of any conflict between these Terms and a separate written agreement between you and Blue Dot Robots, the separate written agreement shall control.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Assignment:</strong> Blue Dot Robots may assign its rights or obligations under these Terms and Conditions without condition to any affiliate, subsidiary, or successor entity, or in connection with any merger, acquisition, reorganization, or sale of assets. You may not assign, transfer, or delegate your rights or obligations under these Terms and Conditions without our prior written consent, and any attempted assignment without such consent shall be void.
				</ComplianceParagraph>
				<ComplianceParagraph>
					<strong>Waiver:</strong> A waiver by Blue Dot Robots of any provision of these Terms and Conditions or any breach thereof, in any one instance, will not waive such term or condition or any subsequent breach thereof. No failure or delay by Blue Dot Robots in exercising any right hereunder will operate as a waiver thereof, nor will any single or partial exercise of any right preclude any other or further exercise thereof or the exercise of any other right.
				</ComplianceParagraph>
				<ComplianceParagraph>
					<strong>Force Majeure:</strong> Blue Dot Robots shall not be liable for any failure or delay in performance under these Terms and Conditions which is due to fire, flood, earthquake, elements of nature or acts of God, acts of war, terrorism, riots, civil disorders, rebellions or revolutions, pandemics or other public health emergencies, or any other cause beyond the reasonable control of Blue Dot Robots.
				</ComplianceParagraph>
				<ComplianceParagraph>
				...
				<ComplianceParagraph>
					<strong>Language:</strong> This agreement was originally written in English (US). To the extent any translated version of this agreement conflicts with the English version, the English version controls. These Terms and Conditions will be binding upon and will inure to the benefit of Blue Dot Robots and you, and your respective successors and permitted assigns.
				</ComplianceParagraph>
