		...
		<ProfileLayout>
			<SupportSectionContainer title="Terms and Conditions of Service">
				...
				<div>
					...
					<ComplianceParagraph>
						Lever Labs websites ("Websites"), educational robots ("Pip Robots"), and related services (together with the Websites, the "Service") are operated by Blue Dot Robots, Inc. ("Lever Labs," "us," or "we"). Access and use of the Service is subject to the following Terms and Conditions including any future modifications. By accessing or using any part of the Service, purchasing Pip Robots, or creating an account, you represent that you have read, understood, and agree to be bound by these Terms and Conditions.
					</ComplianceParagraph>
					<ComplianceParagraph>
