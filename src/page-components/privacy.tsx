	...
	return (
		<div className="min-h-screen pb-20 px-4 sm:px-8 md:px-16 lg:px-60">
			<div className="relative pt-16 ">
				<ComplianceMainHeader>Privacy Policy</ComplianceMainHeader>
			...
			<div>
				...
				<ComplianceMainHeader>3. How We Process Your Information</ComplianceMainHeader>
				<ComplianceParagraph>
				...
				<ComplianceMainHeader>4. Your Data Subject Rights</ComplianceMainHeader>
				<ComplianceParagraph>
