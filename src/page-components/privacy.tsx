		...
		<ProfileLayout>
			<SupportSectionContainer title="Privacy Policy">
				...
				<div>
					...
					<ComplianceParagraph>
						At Lever Labs, we care about your personal information, so we have prepared this Privacy Policy to explain how we collect, use, and share it. This Privacy Policy applies to Lever Labs websites, Pip educational robots, and related services ("Service"). By using the Service, purchasing Pip robots, or creating an account, you agree with Lever Labs' collection, use, and sharing of your personal information in accordance with the terms of this Privacy Policy.
					</ComplianceParagraph>
					<ComplianceParagraph>
						Please note that Lever Labs is constantly testing and improving our product features and platform capabilities. Any features discussed in this Privacy Policy may not be available to all users or in all jurisdictions. Use of the Service is also governed by our Terms and Conditions of Service, and certain Lever Labs services may be subject to additional or different terms.
					</ComplianceParagraph>

					<ComplianceSectionHeader>2. Information We Collect</ComplianceSectionHeader>
					<ComplianceParagraph>
						When you use the Service, Lever Labs may collect the following personal information about you.
					</ComplianceParagraph>

					<ComplianceSectionHeader>a. Account Registration</ComplianceSectionHeader>
					<ComplianceParagraph>
						To register for a Lever Labs account, you may provide us with your age and email address. If you are under the age of 13, we require you to provide your parent's or legal guardian's email address instead of your own. When schools create accounts for their students, the school provides the necessary information and acts as our agent for obtaining parental consent for users under 13, as outlined in our {""}
						<Link
							href="/terms"
							className="underline"
						>
					...
					<ComplianceParagraph>
						When you access the Lever Labs website and platform, we may store certain data locally in your browser. We use browser local storage to maintain your login session and save your learning progress across sessions. Additionally, third-party services like Google Analytics may set cookies on your device as described in their privacy policies.
					</ComplianceParagraph>
					<ComplianceParagraph>
					...
					<ul className="list-disc pl-6 text-wolf text-sm md:text-base font-light leading-relaxed mb-4">
						...
						<li>Delete your Lever Labs account by following the instructions in the Service</li>
					</ul>
					<ComplianceParagraph>
						...
						<Link
							href="mailto:hello@leverlabs.com?subject=Parental%20Request"
							className="underline"
						>
							hello@leverlabs.com
						</Link> {""}
					...
					<ComplianceParagraph>
						...
						. You may also delete your Lever Labs account at any time through your account settings, though this action cannot be undone and will result in loss of access to your projects and learning progress.
					</ComplianceParagraph>
					<ComplianceParagraph>
						Please note that these rights are not absolute and Lever Labs may refuse requests to exercise data subject rights if there is a legitimate reason, such as if we cannot authenticate your identity, if the request could violate the rights of a third party or applicable law, or if the request could interfere with our educational services or prevent us from delivering services you requested. We will explain our reasoning if we are unable to fulfill a particular request.
					</ComplianceParagraph>

					<ComplianceSectionHeader>5. Data Retention</ComplianceSectionHeader>
					<ComplianceParagraph>
						Lever Labs will generally retain your personal information, robotics projects, and learning progress data indefinitely to provide continuity in your educational experience and to support our mission of advancing robotics education through research and platform improvement. This indefinite retention allows students to return to their work after breaks from the platform, enables longitudinal educational research, and helps us understand long-term learning patterns in robotics and programming education. Your data may be retained even after account deletion in anonymized or aggregated form for research and platform improvement purposes.
					</ComplianceParagraph>
					<ComplianceParagraph>
						When you delete your Lever Labs account, your personal identifying information will be removed from public view and your profile will be deactivated. However, your robotics projects and educational content may be retained on our servers in anonymized form, with all personal identifiers removed, to preserve the educational value of shared projects and to support ongoing research into effective robotics education methods. Projects that have been shared with other users or made public may remain visible on the platform but will no longer be associated with your personal information. Lever Labs may retain certain information longer if necessary to provide our educational services, defend our legitimate interests, comply with legal requirements, or resolve disputes.
					</ComplianceParagraph>

					<ComplianceSectionHeader>6. Child Users</ComplianceSectionHeader>
					<ComplianceParagraph>
						We know that children deserve extra privacy protection. That's why we treat Child Users (meaning users under the age of 13 in the United States) differently to ensure their parents are in control and we only collect the bare minimum information we need to make our robotics education platform work effectively. Lever Labs is designed as an educational tool suitable for learners of all ages, and we take special care to provide age-appropriate content and safety measures for our youngest users.
					</ComplianceParagraph>
					<ComplianceParagraph>
						Child Users are permitted to create a Lever Labs account, but we require them to provide their parent's email address instead of their own, and to register using a username that is not tied to their real name. When schools create accounts for Child Users, the school acts as Lever Labs' agent for obtaining parental consent and represents that it has the authority to provide such consent as part of its educational mission and enrollment agreements with families.
					</ComplianceParagraph>
					<ComplianceParagraph>
						After a Child User registers (either individually or through a school), we will send an email to the parent's email address about Lever Labs' privacy practices regarding Child Users, including what personal information we collect and how we use, share, and protect that personal information. The email also explains how parents can request to access, change, or delete information about their child, and how to contact us with any privacy-related questions or concerns.
					</ComplianceParagraph>
					<ComplianceParagraph>
						All Child Users receive the following special treatment when using Lever Labs ("Age Restrictions"):
					</ComplianceParagraph>
					<ul className="list-disc pl-6 text-wolf text-sm md:text-base font-light leading-relaxed mb-4">
					...
					<ComplianceParagraph>
						Child Users may not provide Lever Labs with their real name, contact information, or other personal information beyond what is necessary for the educational service. Child Users cannot link their Lever Labs account to their contact information. Child Users' Profiles contain no personal information that could be used to publicly identify or contact the child, but only the Child User's username and information about their robotics learning progress.
					</ComplianceParagraph>
					<ComplianceParagraph>
					...
					<ComplianceParagraph>
						...
						<Link
							href="mailto:hello@leverlabs.com?subject=Consumer%20Account%20Inquiry"
							className="underline"
						>
							hello@leverlabs.com
						</Link>
					...
					<ComplianceParagraph>
						...
						<Link
							href="mailto:hello@leverlabs.com?subject=Troubleshooting%20Inquiry"
							className="underline"
						>
							hello@leverlabs.com
						</Link>
