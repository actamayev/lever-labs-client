...
import { CodingBlock, Lesson } from "@actamayev/lever-labs-common-ts/types/quest"
...
import markLessonComplete from "../utils/quest/mark-lesson-complete"
import submitMatchingAnswer from "../utils/quest/submit-matching-answer"
import submitFillInBlankAnswer from "../utils/quest/submit-fill-in-blank-answer"
import stopCurrentlyRunningCode from "../utils/sandbox/stop-currently-running-code"
import submitFunctionToBlockAnswer from "../utils/quest/submit-function-to-block-answer"
import submitBlockToFunctionAnswer from "../utils/quest/submit-block-to-function-answer"
import submitActionToCodeOpenEndedAnswer from "../utils/quest/submit-action-to-code-open-ended-answer"
import submitActionToCodeMultipleChoiceAnswer from "../utils/quest/submit-action-to-code-multiple-choice-answer"
...
class QuestClass {
	...
	public checkCurrentAnswer = action(async (lessonId: LessonUUID): Promise<boolean> => {
		...
		// Update the question's correctness in the quest class
...
const questClass = new QuestClass()

export default questClass
