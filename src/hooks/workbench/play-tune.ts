...
export default function usePlayTune(): () => Promise<void> {
	...
	return useCallback(async () => {
		try {
			...
			const playTuneResponse = await blueDotApiClient.workbenchDataService.playTune(
	...
	}, [blueDotApiClient.workbenchDataService, pipClass.selectedPip?.pipUUID, toast, workbenchClass.selectedSound])
}
