...
export const CustomMultizoneDistanceSensor: LucideIcon = forwardRef<SVGSVGElement, LucideProps>(
...
CustomMultizoneDistanceSensor.displayName = "CustomMultizoneDistanceSensor"
