...
const MEET_PIP_COMPONENTS: Record<string, () => ReactNode> = {
	...
	"meet-pip-s5-p4-imu-viz": (): ReactNode => <MeetPipS5P4ImuViz />,
	"meet-pip-s5-p5-ball-moving": (): ReactNode => <MeetPipS5P5BallMoving />,
	"meet-pip-s6-p4-mz-viz": (): ReactNode => <MeetPipS6P4MzViz />,
	"meet-pip-s6-p6-tofs-viz": (): ReactNode => <MeetPipS6P6TofsViz />,
	"meet-pip-s8-p3-color-viz": (): ReactNode => <MeetPipS8P3ColorViz />,
	"meet-pip-s9-p6-encoder-viz": (): ReactNode => <MeetPipS9P6EncoderViz />,
	"meet-pip-dino-leaderboard": (): ReactNode => <DinoLeaderboard />,
}

export default MEET_PIP_COMPONENTS
