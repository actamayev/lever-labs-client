...
export default function Contact() {
	return (
		<div>
			...
			<div className="text-slate-950 dark:text-slate-200 py-5 px-48">
				<div className="text-3xl text-slate-950 dark:text-slate-200 mb-2">
					Contact Us
				</div>
				<div className="grid grid-cols-2 gap-4">
					...
					<div className="flex flex-col items-center">
						<div
							className="border border-slate-200 dark:border-slate-700 rounded-lg py-1 \
							px-0.5 mx-auto bg-white dark:bg-slate-800 w-80 mt-10"
						>
