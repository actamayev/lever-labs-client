	...
	},
	{
		...
		text: (
			...
			When you see Pip's green status light, you're actually seeing photons that have:
				<ol className="list-decimal list-inside mt-2">
					<li>Been generated by the LED</li>
					<li>Transmitted through its clear casing</li>
					<li>Reflected off various surfaces</li>
					<li>Finally been absorbed by the light-sensitive cells in your eyes</li>
