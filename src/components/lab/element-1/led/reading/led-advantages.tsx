...
const ledAdvantagesBlocks: ContentBlock[] = [
		...
		text: (
			<div>
				...
				<ReadingBlockWithImage>
					<BoldSpanText>Energy Efficiency</BoldSpanText>
					<div className="mt-2">
	...
	},
	{
		...
		text: (
			<ReadingBlockWithImage>
				<BoldSpanText>Durability & Size</BoldSpanText>
				<div className="mt-2">
	...
	},
	{
		...
		text: (
			<ReadingBlockWithImage>
				<BoldSpanText>Smart Features</BoldSpanText>
				<div className="mt-2">
	...
	},
	{
		...
		text: (
			<ReadingBlockWithImage>
				<BoldSpanText>Environmental Impact</BoldSpanText>
				<div className="mt-2">
					<ul>
