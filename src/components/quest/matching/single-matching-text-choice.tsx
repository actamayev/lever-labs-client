...
function SingleMatchingTextChoice(props: SingleMatchingTextChoiceProps): React.ReactNode {
	...
	const isSelected = questClass.isMatchingAnswerChoiceSelected(questionId, matchingAnswerChoiceTextId)
	const isMatched = questClass.isMatchingChoiceMatched(questionId, matchingAnswerChoiceTextId)
	...
	if (selectedBlockId !== null) {
		const currentResult = questClass.getMatchingMatchResult(questionId, selectedBlockId, matchingAnswerChoiceTextId)
	...
	return (
		<TactileButton
			onClick={(): void => questClass.handleMatchingChoiceClick(questionId, matchingAnswerChoiceTextId)}
			className={cn(
