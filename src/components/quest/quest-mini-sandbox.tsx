...
interface QuestMiniSandboxProps {
	codingBlock: CodingBlock
	className?: string
}

// eslint-disable-next-line max-lines-per-function
function QuestMiniSandbox({ codingBlock, className = "" }: QuestMiniSandboxProps): React.ReactNode {
...
export default observer(QuestMiniSandbox)
