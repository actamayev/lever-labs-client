				...
				<div className="space-y-3 sm:space-y-4">
					<div className="flex items-start">
						...
						<div className="ml-3 sm:ml-4">
							<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Beginner friendly</h3>
					...
					<div className="flex items-start">
						<ShowIcon icon={Cog}/>
						<div className="ml-3 sm:ml-4">
							<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Ready for more</h3>
							<p className="text-sm sm:text-base md:text-base leading-relaxed text-lightLandingPageText mt-1">
					...
					<div className="flex items-start">
						...
						<div className="ml-3 sm:ml-4">
							<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Explore freely</h3>
							<p className="text-sm sm:text-base md:text-base leading-relaxed text-lightLandingPageText mt-1">
