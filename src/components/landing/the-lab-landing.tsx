					...
					<div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
						<div className="flex items-start">
							...
							<div className="ml-3 sm:ml-4">
								<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Demos</h3>
						...
						<div className="flex items-start">
							...
							<div className="ml-3 sm:ml-4">
								<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Read</h3>
								<p className="text-sm sm:text-base md:text-base leading-relaxed text-lightLandingPageText mt-1">
						...
						<div className="flex items-start">
							<ShowIcon icon={Code2} />
							<div className="ml-3 sm:ml-4">
								<h3 className="text-lg sm:text-xl font-semibold text-pipThemeText">Code</h3>
								<p className="text-sm sm:text-base md:text-base leading-relaxed text-lightLandingPageText mt-1">
									Solve fun coding challenges that test your skills and bring Pip to life!
								</p>
								<p className="text-sm sm:text-base md:text-base leading-relaxed text-lightLandingPageText mt-2 sm:mt-3">
