...
function NotificationBox() {
	...
	return (
		...
		>
			<div
				className={`fixed bottom-2 right-2 transform -tranzinc-x-1/2 ${notificationsClass.notificationBoxClasses} \
				...
				style={{
					...
					transform: notificationsClass.notification ? "tranzincY(0)" : "tranzincY(100%)",
