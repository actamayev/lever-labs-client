		...
		>
			<div className="w-full h-full flex flex-col px-7">
				...
				<div className="flex items-start flex-col" style={{ height: "55%", marginTop: "36px" }}>
					...
					<div className="text-base text-white leading-relaxed mt-10 font-medium">
						{careerDescription}
					</div>
				</div>

				{/* Two Columns: Components | Coding Concepts */}
				<div className="flex items-center justify-between" style={{ height: "45%" }}>
					...
					{/* Divider */}
					<div className="bg-white/60 rounded-2xl" style={{ width: "2px", height: "84px" }} />
				...
				<div style={{ height: "20%" }}>
					<div className="pb-4 flex flex-row items-center gap-3">
						<div className="flex-1">
							<div className={cn("bg-white h-10 rounded-full text-base w-full flex items-center justify-center", colors.text2)}>
