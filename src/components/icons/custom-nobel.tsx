...
export const CustomNobel: LucideIcon = forwardRef<SVGSVGElement, LucideProps>(
	({ color = "currentColor", size = 24, className = "", ...props }, ref) => (
		...
		>
			...
			<path d="M1.62 3.866a.225.225 0 0 0 0-.45h-.56a.225.225 0 0 0 0 .45zm2.946-.468h.492a.225.225 0 0 0 .225-.225.225.225 0 0 0-.225-.225h-.492a.225.225 0 0 0 0 .45m.085-.72h.443a.225.225 0 0 0 .225-.225.225.225 0 0 0-.225-.225h-.443a.225.225 0 0 0 0 .45" />
		</svg>
	)
)
